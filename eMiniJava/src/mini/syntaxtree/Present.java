 ...
 * nodeToken4 -> ";"
 */
public @SuppressWarnings("all") class Present implements Node {
   private Node parent;
   ...
   public Present(NodeToken n0, NodeToken n1, Exp n2, NodeToken n3, Exp n4, NodeToken n5, NodeToken n6) {
      nodeToken = n0;
   ...
   public Present(Exp n0, Exp n1) {
      nodeToken = new NodeToken("Minijava.present");
      if ( nodeToken != null ) nodeToken.setParent(this);
