 ...
 * nodeToken3 -> ";"
 */
public @SuppressWarnings("all") class Read implements Node {
   private Node parent;
   ...
   public Read(NodeToken n0, NodeToken n1, Identifier n2, NodeToken n3, NodeToken n4) {
      nodeToken = n0;
   ...
   public Read(Identifier n0) {
      nodeToken = new NodeToken("Minijava.scanf");
      if ( nodeToken != null ) nodeToken.setParent(this);
