 ...
 * nodeToken3 -> ";"
 */
public @SuppressWarnings("all") class Println implements Node {
   private Node parent;
   ...
   public Println(NodeToken n0, NodeToken n1, Exp n2, NodeToken n3, NodeToken n4) {
      nodeToken = n0;
