 ...
 * nodeToken3 -> ";"
 */
public @SuppressWarnings("all") class Srand implements Node {
   private Node parent;
   ...
   public Srand(NodeToken n0, NodeToken n1, Exp n2, NodeToken n3, NodeToken n4) {
      nodeToken = n0;
   ...
   public Srand(Exp n0) {
      nodeToken = new NodeToken("Minijava.srand");
      if ( nodeToken != null ) nodeToken.setParent(this);
