 ...
 */
public @SuppressWarnings("all") class CompareSmallEquExpression implements Node {
   private Node parent;
   public PrimaryExpression primaryExpression;
   public NodeToken nodeToken;
   public PrimaryExpression primaryExpression1;

   public CompareSmallEquExpression(PrimaryExpression n0, NodeToken n1, PrimaryExpression n2) {
   ...
   public CompareSmallEquExpression(PrimaryExpression n0, PrimaryExpression n1) {
      primaryExpression = n0;
      if ( primaryExpression != null ) primaryExpression.setParent(this);
