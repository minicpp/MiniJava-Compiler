 ...
 * nodeToken7 -> ";"
 */
public @SuppressWarnings("all") class Color implements Node {
   private Node parent;
   ...
   public Color(NodeToken n0, NodeToken n1, Exp n2, NodeToken n3, Exp n4, NodeToken n5, Exp n6, NodeToken n7, Exp n8, NodeToken n9, Identifier n10, NodeToken n11, NodeToken n12) {
      nodeToken = n0;
   ...
   public Color(Exp n0, Exp n1, Exp n2, Exp n3, Identifier n4) {
      nodeToken = new NodeToken("Minijava.color");
      if ( nodeToken != null ) nodeToken.setParent(this);
