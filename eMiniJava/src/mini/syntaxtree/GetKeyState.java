 ...
 * nodeToken4 -> ";"
 */
public @SuppressWarnings("all") class GetKeyState implements Node {
   private Node parent;
   ...
   public GetKeyState(NodeToken n0, NodeToken n1, Exp n2, NodeToken n3, Identifier n4, NodeToken n5, NodeToken n6) {
      nodeToken = n0;
   ...
   public GetKeyState(Exp n0, Identifier n1) {
      nodeToken = new NodeToken("Minijava.getkey");
      if ( nodeToken != null ) nodeToken.setParent(this);
